      ...
      <div className="w-full md:w-[40%] flex flex-col justify-center relative mt-6 md:mt-0">
        ...
        <div className="pl-0 md:pl-6 text-black text-center md:text-left">
          <p className="text-2xl md:text-3xl header-text leading-relaxed mb-4">
            Join us from <span className="font-medium">October 6th - 8th, 2025</span> for a transformative experience at ATINUDA 2025. We’re bringing together industry leaders, creative visionaries, and business decision-makers to explore the next frontier of luxury, events, and global influence.
          </p>
